...
<div class="searchContainer">
	...
	<h4>Search for an artist, song or playlist</h4>
...
$(function() {
	...
	$(".searchInput").keyup(function() {
		...
		timer = setTimeout(function() {
			...
			openPage("artistSearch.php?term=" + val);
		}, 2000);
	})
	...
	<ul id="trackPart" class="tracklist">
		...
		while($row = mysqli_fetch_array($songsQuery)) {
			...
			echo "<li class='tracklistRow'>
					...
					<div class='trackInfo'>
						<span role='link' tabindex='0' class='trackName' onclick='openPage(\"artistSong.php?id=" . $albumSong->getId() ."\")'>" . $albumSong->getTitle() . "</span>
						<span role='link' tabindex='0' class='artistName' onclick='openPage(\"artistArtist.php?id=" . $albumArtist->getId() ."\")'>" . $albumArtist->getName() . "</span>
					</div>
	...
	while($row = mysqli_fetch_array($artistsQuery)) {
		...
		echo "<div class='searchResultRow'>
				<div class='artistName'>
					...
					<span role='link' tabindex='0' onclick='openPage(\"artistArtist.php?id=" . $artistFound->getId() ."\")'>
					"
					. $artistFound->getName() .
					"
					</span>
...
<div class="tracklistContainer borderBottom">
	...
	<?php
		...
		while($row = mysqli_fetch_array($albumQuery)) {
			...
			echo "<li class='tracklistRow'>
			        <div class='trackInfo'>
					<span class='trackName' role='link' tabindex='0' onclick='openPage(\"artistotherplaylist.php?id=" . $row['id'] . "\")'>". $row['name'] ."</span>
...
<div class="tracklistContainer borderBottom">
	...
	<?php
		...
		while($row = mysqli_fetch_array($albumQuery)) {
			...
			echo "<li class='tracklistRow'>
			        <div class='trackInfo'>
					<span class='trackName' role='link' tabindex='0' onclick='openPage(\"artistUser.php?id=" . $row['id'] . "\")'>". $row['username'] ."</span>
