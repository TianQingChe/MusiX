			...
			foreach($followers as $follwer){
				if ($follwer->getUserType()==1){
					echo "<li class='tracklistRow'>
						<div class='trackInfo'>
							<span class='trackName' role='link' tabindex='0' onclick='openPage(\"user.php?id=" . $follwer->getId() . "\")'>"
					...
					echo "<li class='tracklistRow'>
						<div class='trackInfo'>
							<span class='trackName' role='link' tabindex='0' onclick='openPage(\"artist.php?id=" . $follwer->getId() . "\")'>"
						  . $follwer->getUsername() . "</span>
