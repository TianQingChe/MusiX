...
<body>
	...
	<div id="background">
		<div id="loginContainer">
			<div id="inputContainer">
				...
				<form id="registerForm" action="login.php" method="POST">
					...
					<p>
						...
						<input id="firstName" name="firstName" type="text" placeholder="Firstname" value="<?php getInputValue('firstName') ?>" required>
					</p>
					...
					<p>
						...
						<select id="userType" class="inline" name="userType" style="background-color: transparent;color: gray;">
							<option value=1 selected="selected" style="color: gray;">Audience</option>
							<option value=2 style="color: gray;">Artist</option>
						</select>
					</p>
			...
			<div id="loginText">
				<h1>Get great music or Upload your first track, right now</h1>
